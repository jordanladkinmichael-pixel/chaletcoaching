...
- [x] Репозиторий / окружения (dev/prod), переменные окружения
- [x] Базовый layout (Header / Footer), контейнеры, сетка, типографика
- [x] Токены дизайна (цвета/радиусы/тени/spacing), WCAG фокус-стейты
- [x] Компоненты UI-kit (Button, Card, Badge, Avatar, Tabs, Accordion, Switch, Skeleton, Drawer/Sheet, Toast)
- [x] Навигация на Next.js routes (без setActive для страниц)
- [x] SEO базовый: мета, OG, sitemap/robots (минимум)
- [x] Перфоманс база: poster-first для 3D, reduced motion
...
- Дата старта: ****\_\_\_****
- Целевая дата MVP: ****\_\_\_****
- Самые критичные страницы: **********\_\_**********
- Что блокирует релиз сейчас: **********\_**********
