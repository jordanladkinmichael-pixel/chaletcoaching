...
export default function GeneratorPageContent() {
  ...
  // Auth handler - always redirect to sign-in with returnTo
  // Accepts mode parameter for compatibility with SiteHeader but ignores it
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const openAuth = (_mode?: "signup" | "signin") => {
    const returnTo = buildReturnTo();
    router.push(`/auth/sign-in?returnTo=${encodeURIComponent(returnTo)}` as Route);
  };
